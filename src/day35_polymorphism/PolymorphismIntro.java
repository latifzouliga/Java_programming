...
import day31_inheritance.animal_methodOverRidding.Animal;
import day31_inheritance.shapeMethodOverridding.*;
import day33_abstraction.employeeTask.*;
import day34_abstraction.animalTask_interface.*;
    ...
    public class PolymorphismIntro {
        ...
        public static void main(String[] args) {
           ...
           //Animal[] animals = {dog, cat, tiger, lion, eagle, parrot, dolphin, shark, duck};
            ...
            Animal animal = new Animal("Max", "Husky", 'M', 4, "Small", "White");
