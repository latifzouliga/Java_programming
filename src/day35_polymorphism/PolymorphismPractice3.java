...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        ...
        for (Employee each : employees) {
            if (each instanceof Developer){  // count devs
                countDevs++;
            } else if (each instanceof Tester) {  // count testers
                countTesters++;
            } else if (each instanceof  Driver) { // count drivers
                countDriver++;
            }else {                     // count testers
                countTeachers++;
            }
        }
        System.out.println("Number of developers: " + countDevs);
        System.out.println("Number of Testers = " + countTesters);
        System.out.println("Number of Driver = " + countDriver);
        System.out.println("Number of Teachers = " + countTeachers);
