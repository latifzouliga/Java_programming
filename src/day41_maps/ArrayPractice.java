...
public class ArrayPractice {
    ...
    public static void main(String[] args) {
        ...
        List<Integer>[] arrayOfLists = new List[3];  // an array of arrayList
        ...
        arrayOfLists[0].set(4, 50);  // re-assigning an arrayList element in array

        System.out.println(Arrays.toString(arrayOfLists));


        Set<Integer>[] arrayOfSets = new Set[5]; // an array of Sets
        arrayOfSets[0] = new LinkedHashSet<>(Arrays.asList(100,200,300,500,600));
        ...
        arrayOfSets[2].addAll(Arrays.asList(1, 2, 3, 4)); // adding Set to an array
