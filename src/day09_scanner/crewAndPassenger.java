...
public class crewAndPassenger {
    ...
    public static void main(String[] args) {
        ...
        // ternary accept only one statement in its body

        String resul1 = (number == 50 || number == 75 || number == 100) ?
        ...
        switch (number) {    // switch statement can not be a boolean, it can be a data only
