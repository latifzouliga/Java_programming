...
public class TipCalculator {
    ...
    public static void main(String[] args) {
        ...
        String yesNo = inpput.next().toLowerCase();// YES ===========> yes

        System.out.println("Enter the number of people");
        int numberOfPeople = inpput.nextInt();

        System.out.println("Enter the check amount");
        double amount = inpput.nextDouble();

        System.out.println("Service Quality (Excellent/Great/Good/Fair/Poor)");
        String service = inpput.next().toLowerCase();
        ...
        System.out.println("Totla tip: " + totalTip);
